...
class CustomerRepositoryTest {
    ...
    fun `should return name containing`() {
        ...
        val daniel = customerRepository.save(buildCustomer(name = "Marcos"))
        val ronaldo = customerRepository.save(buildCustomer(name = "Matheus"))
        customerRepository.save(buildCustomer(name = "Alex"))

        val customer = customerRepository.findByNameContaining("Ma")

        assertEquals(listOf(daniel, ronaldo), customer)
